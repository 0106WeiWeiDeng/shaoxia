    ...
    <div class="parameters">
      ...
      <div v-if="isSelectedData">
        ...
        <div class="anno" v-if="isShowAnno">
          ...
          <div>
            <p>marker_gene_order: <input type="text" style="width: 200px;" v-model="marker_gene_order"></p>
            <p>cluster_name_order: <input type="text" style="width: 200px;" v-model="cluster_name_order"></p>
